...
export const carouselFormFields = [
  {
    name: "title",
    label: "Carousel Title",
    type: "text" as const,
    required: true,
    placeholder: "Enter carousel campaign title",
  },
  {
    name: "description",
    label: "Description",
    ...
    required: true,
    placeholder: "Describe the carousel campaign",
  },
  {
    name: "imageUrl",
    label: "Image URL",
  ...
  },
  {
    ...
    type: "text" as const,
    required: false,
    placeholder: "https://example.com/carousel-video.mp4",
  },
  {
    name: "targetUrl",
    label: "Target URL",
