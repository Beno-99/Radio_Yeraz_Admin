...
export type CarouselFiltersState = {
  isActive?: "all" | "true" | "false";
  platform?: "all" | "web" | "mobile" | "both";
  search?: string;
};

export type CarouselSortState = {
  field: string;
  direction: "asc" | "desc";
};
...
interface CarouselFiltersProps {
  ...
  sort: CarouselSortState;
  onFilterChange: (filters: CarouselFiltersState) => void;
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) =>
              onFilterChange({
                ...filters,
                isActive: e.target.value as CarouselFiltersState["isActive"],
              })
            }
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            onChange={(e) =>
              onFilterChange({
                ...filters,
                platform: e.target.value as CarouselFiltersState["platform"],
              })
            }
            className="w-full rounded-lg border border-gray-300 px-3 py-2"
          >
